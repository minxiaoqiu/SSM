...
<head>
    <title>员工列表</title>
    <!-- web路径：
        一般的不以/开始的相对路径，找资源，而是以当前资源的路径为基准，经常容易出问题。
        现在以/开始的相对路径，找资源，以服务器的路径为标准(http://localhost:8080)；需要加上项目名
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-8">
            <button class="btn btn-primary btn-sm" id="emp_add_modal_btn"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
            </button>
            <button class="btn btn-danger btn-sm" id="emp_delete_all_btn"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>删除
            </button>
        </div>
    </div>
    <!-- 显示表格数据 -->
